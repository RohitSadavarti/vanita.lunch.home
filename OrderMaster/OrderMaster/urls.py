...
urlpatterns = [
    ...
    # The root path now points to the dashboard. The @login_required decorator in 
    # views.py will automatically redirect any non-logged-in users to '/login/'.
    path('', views.dashboard, name='dashboard'),
    
    # This creates the explicit '/login/' URL that was missing.
