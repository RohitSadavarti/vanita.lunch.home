...
MIDDLEWARE = [
    ...
    # --- Whitenoise Middleware (add this line) ---
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'OrderMaster', 'templates')], # Ensure this points to your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'OrderMaster/static')]
